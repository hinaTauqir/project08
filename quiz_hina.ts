...
let askQuestion=async ()=>
{
   let ans=await inquirer.prompt([
    ...
    if(ans.q1=="Charles Babbage"){score+=10;
    console.log(chalk.green("charles Babbage is correct answer"))}
    else {console.log(chalk.red("charles Babbage is correct answer, your answer is wrong"))}
    if (ans.q2=="Central Processing Unit"){score+=10;
        console.log(chalk.green("Central Processing Unit is correct answer"))}
    else{ console.log(chalk.red("Central Processing Unit is correct answer, your answer is wrong"))} 
    if(ans.q3=="machine language"){score+=10;
        console.log(chalk.green("machine language is correct answer"))}
    else { console.log(chalk.red("machine language is correct answer, your answer is wrong"))}
    if(ans.q4=="Central Processing Unit"){score+=10;
        console.log(chalk.green("central processing unit is correct answer"))}
    else {console.log(chalk.red("central processing unit is correct answer, your answer is wrong"))}
